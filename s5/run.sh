...
CU_ROOT=/srv/scratch/z5160268/2020_TasteofResearch/MyST_Kids_Corpus	# Path to CU Kids Speech Corpus on supercomputer

stage=3	# This controls what stage to start running from
